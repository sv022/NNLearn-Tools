...
<template>
    ...
    <div class="flex flex-col items-center h-full w-full">
        <div class="w-[440px]">
            ...
            <NumberField class="p-2" id="size" :disabled="convRGBStore.isKernelSelected" :default-value="3" :min="1"
                :step="2" :max="7" :model-value="convRGBStore.kernel.height">
            ...
            <NumberField class="p-2" id="size" :default-value="1" :min="1"
                :step="1" :max="3" :model-value="convRGBStore.stride">
